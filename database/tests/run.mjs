...
//   2. an existing single-shop database (with data) upgraded by migration 004
//   3. an empty database upgraded by migration 004
...
const scenarios = [
  ...
  ["Upgrade of a single-shop database with data (migration 004)", ["--legacy", legacySeed, before, migration]],
  ["Upgrade of an empty single-shop database (migration 004)", [before, migration]],
];
