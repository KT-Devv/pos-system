    ...
    <div className="flex h-screen bg-background text-foreground overflow-hidden">
      ...
      <aside className="w-64 glass-panel flex flex-col z-20 border-r border-white/5 relative">
        ...
        <div className="p-6 border-b border-white/5 relative z-10">
          <div className="flex items-center gap-3 mb-2">
            <div className="w-8 h-8 rounded-lg bg-primary/20 text-primary flex items-center justify-center border border-primary/30"><span className="font-bold text-lg leading-none">P</span></div>
        ...
        <nav className="flex-1 p-4 space-y-1.5 relative z-10 overflow-y-auto">
          {navItems.map((item) => (
            <NavLink
              ...
              className={({ isActive }) =>
                cn(
                  'flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium relative group overflow-hidden',
                  isActive
        ...
        <div className="p-4 border-t border-white/5 relative z-10 bg-black/20">
          <div className="flex items-center gap-3">
            ...
            <button
              onClick={logout}
              className="p-2 rounded-lg text-muted-foreground hover:text-white hover:bg-white/10 border border-transparent"
              title="Sign out"
            >
      ...
      <main className="flex-1 overflow-auto relative bg-background">
        ...
        <div className="relative z-10 h-full p-2 md:p-6">
          <div className="glass-panel min-h-full rounded-2xl relative">
